								...
								<?php
									foreach($materiais as $lista){
										...
										if($id_produto == $id_chave){
											$emprestada = "Emprestado <span class='glyphicon glyphicon-ban-circle'></span>";
										}
										else{
											$emprestada = "Disponível <span class='glyphicon glyphicon-ok-circle'></span>";
										}
										echo "<tr><td>$nome_note</td><td>$n_patrimonio</td><td>$modelo</td><td align='middle'>$emprestada</td></tr>";
									}
								?>
