			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<a href='relatorio_notebooks.php' style="width: 25px; height: 25px; position: relative; left:95%; top: -30px" id="left" data-toggle="tooltip" data-placement="bottom" title="Gerar Relatório de Empréstimo de Notebooks"><span aria-hidden="true" class="glyphicon glyphicon-duplicate"></span></a>
					</div>
					<!-- /.panel-heading -->
