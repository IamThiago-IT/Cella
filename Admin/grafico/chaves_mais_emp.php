...
try{ //tente
	...
	$sql = "SELECT casa.nome_casa, COUNT(tb_historico_emp.id_emprestimo) as quantidade, tb_historico_emp.casa FROM tb_historico_emp INNER JOIN casa ON casa.id_casa = tb_historico_emp.casa WHERE tb_historico_emp.tipo_prod = 2 AND (data_hora_emprestimo >= '$Ddiferenca') GROUP BY casa";
...
$grafico = array(
    ...
    'config' => array(
        'title' => 'Gráfico da quantidade que cada casa emprestou chaves no último mês.',
        'width' => 500,
        'height' => 400
    )
);
