				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h2>Lista de empréstimos de chaves</h2>
							<a href='relatorio_emprestimos.php' id="left" style="width: 25px; height: 25px; position: relative; left:95%; top: -50px" data-toggle="tooltip" data-placement="bottom" title="Gerar Relatório de Empréstimo de Chaves"><span aria-hidden="true" class="glyphicon glyphicon-duplicate"></span></a>
					</div>
					<!-- /.panel-heading -->
