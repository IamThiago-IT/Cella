...
try{ //tente
	...
	$sql = "SELECT COUNT(tb_produtos.id_produto) as quantidade, REPLACE(tb_tipos.descricao, 'chave', 'Chaves não emprestadas') as nome_casa 
	...
	WHERE tb_emprestimos.tipo_prod = 2 GROUP BY casa";
