		...
		<div class="col-md-9">
            <div class="profile-content">
			   ...
			   <div class="col-md-6" style="border: none; float: left; max-width: 100%; width: 50%; padding: 10px;">
						E-mail de suporte:<br>
							<h5>thiagodossantos315@gmail.com<br>
							mariaenegrelli@gmail.com<br>
							rafaelcsmah@gmail.com</h5>
				</div><br><br><br><br>
			 </fieldset>
			</div>
		</div>
...
<a href="https://wa.me/5541985120472?text= 	<?php echo $Professor;?>Estou%20com%20problemas" style="position:fixed;width:60px;height:60px;bottom:40px;right:40px;background-color:#25d366;color:#FFF;border-radius:50px;text-align:center;font-size:30px;box-shadow: 1px 1px 2px #888;
