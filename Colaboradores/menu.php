...
<html lang="pt-br">
	...
	<body>
		...
		<a href="javascript:history.back()">
			<button type="button" class="voltar"> <b>< Voltar</b></button>
		</a>
				</div>
						...
						<ul class="nav navbar-nav">
							<li class="arq">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="colaborador_saida.php"style="background-color:white;">Saída</a></li>
								</ul>
							</li>
							<li class="arq">
							...
							<li class="arq">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="Colaboradores_chaves.php" style="background-color:white;">Chaves</a></li>
									<li><a href="colaboradores_notebooks.php"style="background-color:white;">Notebooks</a></li>
									<li><a href="Colaboradores_materiais.php" style="background-color:white;">Materiais</a></li>
								</ul>
							</li>														
								<!------Fim do Submenu------>				
